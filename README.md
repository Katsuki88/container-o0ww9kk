...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o0ww9kk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o0ww9kk.containers.anotherwebservice.com/
...
```
git clone git@github.com:Katsuki88/container-o0ww9kk.git
cd container-o0ww9kk
```
...
```
docker attach container-o0ww9kk
```
